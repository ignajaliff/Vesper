...
const TINTES = [
  ...
  { vidrio: "#C2C6CC", liquido: "#5B6675", tapa: "#2A3038" },
  { vidrio: "#9FB4D6", liquido: "#0A2E66", tapa: "#101418" },
  { vidrio: "#B9C8DE", liquido: "#2E6BC4", tapa: "#0A2E66" },
  { vidrio: "#CBD2DA", liquido: "#8494A8", tapa: "#333A44" },
  { vidrio: "#93A9CE", liquido: "#153E82", tapa: "#101418" },
  { vidrio: "#B0B4B9", liquido: "#3A4048", tapa: "#1B1F25" },
] as const

/**
 * Fondo claro con un halo suave detrás del frasco, como una foto de estudio.
 *
 * Acompaña a la foto principal de producto, que viene sobre fondo claro (ver
 * `bharara-king-sombra.webp`). La toma oscura con la caja es la de hover, no
 * la que define el tono de la grilla.
 */
const FONDO_BORDE = "#DCDEE2"
const FONDO_CENTRO = "#F2F3F5"
...
/**
 * SVG de un frasco de perfume sobre fondo claro con halo, al tono de las
 * fotos reales de producto. Devuelve un data URI listo para `<Image src>`.
 */
...
<defs>
<radialGradient id="f" cx="50%" cy="42%" r="72%">
<stop offset="0%" stop-color="${FONDO_CENTRO}"/>
<stop offset="100%" stop-color="${FONDO_BORDE}"/>
</radialGradient>
</defs>
<rect width="400" height="400" fill="url(#f)"/>
<g transform="translate(200 214)">
<ellipse cx="0" cy="92" rx="76" ry="9" fill="${tapa}" opacity="0.14"/>
